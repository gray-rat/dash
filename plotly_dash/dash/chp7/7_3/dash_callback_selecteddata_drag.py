...
def show_hover_data(selectedData):
    if selectedData:
        ...
        df_selected = gapminder[gapminder['country'].isin(selected_countries)]
        fig1 = px.line(df_selected, x='year', y='pop', color='country', title='各国の人口')
        fig2 = px.line(
            df_selected, x='year', y='lifeExp', color='country', title='各国の平均寿命'
        )
        return fig1, fig2
